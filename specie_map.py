...
for lon1, lat1, dates1 in zip(lon1, lat1, dates1):
    feature_group.add_child(folium.CircleMarker(radius=20,location=[lat1, lon1], popup=dates1, color='#cc3186', fill_color='#cc3186'))
for lon2, lat2, dates2 in zip(lon2, lat2, dates2):
    feature_group.add_child(folium.RegularPolygonMarker(location=[lat2, lon2], popup=dates2, fill_color='#7bde43', radius=20))
